...
APPS = [
    ...
    },
    {
        ...
        "description": "Sistema completo para controle de carteira, custódia e apuração mensal de Imposto de Renda (IR) em Ações, BDRs, Opções e FIIs na B3. Gera DARF (6015), trata Day/Swing Trade, isenção de 20k e prejuízos.",
